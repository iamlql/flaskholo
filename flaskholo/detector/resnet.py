...
from flaskholo.detector.RoiPoolingConv import RoiPoolingConv
from flaskholo.detector.FixedBatchNormalization import FixedBatchNormalization
...
def get_weight_path():
    if K.image_data_format() == 'channels_first':# K.image_dim_ordering() == 'th':
        ...
        return '../models/resnet50_weights_tf_dim_ordering_tf_kernels.h5'
