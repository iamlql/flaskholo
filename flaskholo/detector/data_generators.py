...
def iou(a, b):
    ...
    # 注意，intersection 和 union 需要自定义，这个比较简单
...
def calc_rpn(C, img_data, width, height, resized_width, resized_height, img_length_calc_function):
    """ 有四层循环：1、2层为取出框的尺寸大小。3、4层为选定锚点的坐标，并与实际经过缩放对应的bbox的坐标（x1,y1表示矩形框左上角，x2, y2表示右下角）计算IoU以及进行判断每个锚点对应的9种框是否能匹配到bbox，以及匹配的程度"""
    ...
    # 下面是具体的方法，比较简单，对于没有对应anchor的bbox，在中性anchor里挑最好的
    # 当然前提是你不能跟我完全不相交，那就太过分了。。
